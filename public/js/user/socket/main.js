...
/***/ "./resources/js/user/socket/custom.js":
/*!********************************************!*\
  !*** ./resources/js/user/socket/custom.js ***!
  \********************************************/
/***/ (() => {
...
var socketClient = io("127.0.0.1:9000");
var dataOnline;
var userIdOnline = document.getElementById("info-user-online").getAttribute("data-key");
...
socketClient.on("notify-online", function (data) {
  console.log(data);
  var keys = Object.keys(data);
  dataOnline = data;
  var userDiv = document.getElementById("id-user-of-shop");

  if (userDiv) {
    var userId = userDiv.getAttribute("data-key");

    if (!keys.includes(userId)) {
      var btnChat = document.getElementById('button-chat-user-shop');
      ...
      var _btnChat = document.getElementById('button-chat-user-shop');

      if (_btnChat) {
        _btnChat.classList.remove("d-none");
      } // $("#chatShop").modal("show");
...
var listChat = document.getElementById("list-chat");
var chatContent = document.getElementById("frame-chat-left");
...
listChat.onclick = function (e) {
  ...
  if (e.target.nodeName == "DIV" && e.target.className == "list-chat-item") {
    var arrayContentOfUser = document.getElementsByClassName("content-of-user");

    var _iterator = _createForOfIteratorHelper(arrayContentOfUser),
        _step;

    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var contentOfUser = _step.value;
    ...
    var contentDefault = document.getElementById("content-of-user-default");
...
var iconsChatSmall = document.getElementsByClassName("chat-small");

if (iconsChatSmall) {
  var _iterator2 = _createForOfIteratorHelper(iconsChatSmall),
      _step2;

  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var iconChatSmall = _step2.value;

      iconChatSmall.onclick = function (e) {
        e.preventDefault();
        var frame = document.getElementById("chat-list-frame-tag-id");
...
var btnChatNow = document.getElementById("button-chat-user-shop");
...
if (btnChatNow) {
  btnChatNow.onclick = function (e) {
    ...
    if (frame.classList.contains("d-none")) {
      frame.classList.remove("d-none");
      var userId = document.getElementById("id-user-of-shop").getAttribute("data-key");
      var itemUser = document.getElementById("list-chat-item-" + userId);

      if (itemUser) {
        var frameChatLeft = document.getElementById("content-of-user-" + userId);

        if (frameChatLeft) {
          var frameChatContent = frameChatLeft.children[1];
          var itemReceive = document.createElement("div");
          itemReceive.setAttribute("class", "chat-content-user-receive");
          var pReceive = document.createElement("p");
        ...
        var shopName = document.getElementById("shop-name-" + userId).textContent; // console.log("shop id la" + userId);

        item.textContent = shopName;
        var frameListChat = document.getElementById("list-chat");
        frameListChat.appendChild(item);

        var _frameChatLeft = document.getElementById("frame-chat-left");

        var contentFrameChat = document.createElement("div");
        contentFrameChat.setAttribute("id", "content-of-user-" + userId);
        contentFrameChat.setAttribute("class", "content-of-user");
        var chatContentTop = document.createElement("div");
        chatContentTop.setAttribute("class", "chat-content-top");
        var avatarChat = document.createElement("div");
        avatarChat.setAttribute("class", "avatar-chat");
        var imgAvatar = document.createElement("img");
        var shopAvatar = document.getElementById("shop-avatar-" + userId);
        ...
        var chatContentUser = document.createElement("div");
        chatContentUser.setAttribute("class", "chat-content-user");
        var chatContentUserSend = document.createElement("div");
        var chatContentBottom = document.createElement("div");
        ...
        var buttonChatReply = document.createElement("div");
        ...
        contentFrameChat.appendChild(chatContentBottom); // contentFrameChat.classList.add("d-none");

        var defaultContent = document.getElementById("content-of-user-default");
        defaultContent.classList.add("d-none");

        _frameChatLeft.appendChild(contentFrameChat);
      }
    } else {
      frame.classList.add("d-none");
    }
...
chatContent.onclick = function (e) {
  var buttonsReply = document.getElementsByClassName("button-chat-reply");

  if (buttonsReply) {
    var _iterator3 = _createForOfIteratorHelper(buttonsReply),
        _step3;

    try {
      for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
        var buttonReply = _step3.value;

        buttonReply.onclick = function () {
          var parent = this.parentElement;
          var inputReply = parent.children[0];
          var partnerId = inputReply.id.split("-")[2];
          var content = inputReply.value;
          var tagInfoUserSend = document.getElementById("info-user-online");
          var frameChat = parent.parentElement.children[1];
          ...
          if (dataOnline[partnerId]) {
            ...
            var sendChat = document.createElement("div");
...
socketClient.on("private-message", function (_ref) {
  var content = _ref.content,
      info = _ref.info;
  console.log("noi dung nhan duoc la: " + content);
  console.log("id nguoi gui cho ban: " + info);
  var dataUserReceive = info.split('-');
  var itemUser = document.getElementById("list-chat-item-" + dataUserReceive[0]);

  if (itemUser) {
    var frameChatLeft = document.getElementById("content-of-user-" + dataUserReceive[0]);
    ...
    var _frameChatLeft2 = document.getElementById("frame-chat-left");
    ...
    var chatContentUser = document.createElement("div");
    chatContentUser.setAttribute("class", "chat-content-user");
    var chatContentUserReceive = document.createElement("div");
    chatContentUserReceive.setAttribute("class", "chat-content-user-receive");
    var chatReceiveContent = document.createElement("p");
    ...
    _frameChatLeft2.appendChild(contentFrameChat);
  }
});

/***/ }),

/***/ "./resources/js/user/socket/socket-io.js":
/*!***********************************************!*\
  !*** ./resources/js/user/socket/socket-io.js ***!
  \***********************************************/
...
try {
  io = __webpack_require__(/*! socket.io-client */ "./node_modules/socket.io-client/build/cjs/index.js");
} catch (error) {
  console.log(error);
}
...
(() => {
/*!******************************************!*\
  !*** ./resources/js/user/socket/main.js ***!
  \******************************************/
__webpack_require__(/*! ./socket-io */ "./resources/js/user/socket/socket-io.js");

__webpack_require__(/*! ./custom */ "./resources/js/user/socket/custom.js");
})();
